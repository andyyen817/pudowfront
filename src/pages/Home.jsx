    ...
    <div className="flex flex-col font-sans">
      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-12">Why Choose AirKOP?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                    ...
                    <p className="text-gray-600">ISO9001, SNI, BPOM & Halal certified products.</p>
                </div>
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                    ...
                    <p className="text-gray-600">Premium quality water at community-friendly prices.</p>
                </div>
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                    ...
                    <p className="text-gray-600">Creating jobs and income opportunities for locals.</p>
                </div>
            </div>
        </div>
      </div>
